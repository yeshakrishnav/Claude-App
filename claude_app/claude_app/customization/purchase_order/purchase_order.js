...
/**
 * Client script for the Purchase Order form.
 *
 * Fetches the supplier grade on supplier selection, renders the colour badge,
 * and shows the appropriate warning or error message to the user.
 */
...
frappe.ui.form.on("Purchase Order", {
    ...
    /**
     * Fired when the supplier field value changes.
     *
     * Fetches the supplier's current grade and renders badge + messages.
     *
     * @param {object} frm - The Frappe form instance.
     * @returns {void}
     */
 ...
 *
 * Uses frappe.db.get_value for a lightweight, non-blocking server call.
 *
 * @param {object} frm - The Frappe form instance.
 * @returns {void}
 */
 ...
 *
 * Clears any existing badge before inserting a new one to avoid duplicates.
 *
 * @param {object} frm - The Frappe form instance.
 * @returns {void}
 */
 ...
 *
 * Red   → blocking msgprint (client-side advisory; server validate is authoritative).
 * Yellow → non-blocking warning about approval routing.
 * Ungraded → advisory warning that grade configuration is required.
 * Green   → no message shown.
 *
 * @param {object} frm   - The Frappe form instance.
