...
def validate(doc, method):
    """
    Hook fired on Supplier Quotation validate. Enforces supplier grade procurement rules.
...
def before_submit(doc, method):
    """
    Hook fired before Supplier Quotation submission. Enforces Yellow-supplier workflow gate.

    Blocks submission when the supplier grade is Yellow and the document has not
    been approved through the configured Yellow Supplier SQ Approval workflow.
